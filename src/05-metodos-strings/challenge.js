...
console.log(extraerDesdeFinal("Pauline en Mexico", 6));
...
console.log(incluyeSubcadena("Pauline en Mexico", "Pauline"));
...
console.log(empiezaCon("Pauline en Mexico", "en"));
...
console.log(reemplazarPrimera("Hola mundo, Hola Javascript", "Hola", "Hi"));
